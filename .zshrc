if [ -z "$TMUX" ]; then
  exec tmux new-session -A -s pumpkin
fi
...
alias ipv4="curl -s ifconfig.co"
alias speedtest="curl -s https://raw.githubusercontent.com/sivel/speedtest-cli/master/speedtest.py | python - | grep load: | cat"
alias pipes="./pipes.sh -t 3"
alias audiovis="/mnt/c/winscap.exe 2 48000 16 > /home/rohan/cava.fifo & cava"
export MANPAGER='nvim +Man!'
# Created by `pipx` on 2024-11-28 05:25:09
